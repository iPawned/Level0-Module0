...
if __name__ == '__main__':
    ...
    adj = simpledialog.askstring(title='Question 1', prompt="Name a adjective.")
    # Get the player to enter a type of liquid
    liq = simpledialog.askstring(title='Question 2', prompt="Name a liquid.")
    # Get the player to enter a body part
    bp = simpledialog.askstring(title='Question 3', prompt="Name a body part.")
    # Get the player to enter a verb
    verb = simpledialog.askstring(title='Question 4', prompt="Name a verb.")
    # Get the player to enter a place
    place = simpledialog.askstring(title='Question 5', prompt="Name a place.")
